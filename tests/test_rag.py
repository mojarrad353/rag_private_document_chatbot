...
def rag_service():
    ...
    with patch("src.rag.RAGService.embeddings", new_callable=PropertyMock) as mock_emb, \
...
def test_process_file(
    mock_chroma, mock_splitter, mock_loader, rag_service
):
...
def test_get_answer_success(mock_cb, mock_memory, mock_redis, mock_chroma, mock_chain, rag_service):
